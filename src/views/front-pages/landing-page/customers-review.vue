...
const reviewData = [
  {
    desc: 'I\'ve never used a theme as versatile and flexible as Cleaning Service Admin Panel. It\'s my go to for building dashboard sites on almost any project.',
    img: logo1,
    rating: 5,
    name: 'Eugenia Moore',

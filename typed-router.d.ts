...
declare module 'vue-router/auto/routes' {
  export interface RouteNamedMap {
    ...
    'apps-expense-attachments': RouteRecordInfo<'apps-expense-attachments', '/apps/expense_attachments', Record<never, never>, Record<never, never>>,
    'apps-expense-attachments-edit-id': RouteRecordInfo<'apps-expense-attachments-edit-id', '/apps/expense_attachments/edit/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    'apps-expense-attachments-list': RouteRecordInfo<'apps-expense-attachments-list', '/apps/expense_attachments/list', Record<never, never>, Record<never, never>>,
    'apps-expense-heads': RouteRecordInfo<'apps-expense-heads', '/apps/expense_heads', Record<never, never>, Record<never, never>>,
    'apps-expense-heads-edit-id': RouteRecordInfo<'apps-expense-heads-edit-id', '/apps/expense_heads/edit/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    'apps-expense-heads-list': RouteRecordInfo<'apps-expense-heads-list', '/apps/expense_heads/list', Record<never, never>, Record<never, never>>,
